...
public class Libro {
  ...
  @TestOnly public static void setEjemploLibros(Vector<Libro> initialBooks) {
    Libro.initialBooks = initialBooks;
  }

  @TestOnly public static void resetToInitialValues() {
    initialBooks.clear();
    initialBooks.add(
        new Libro("Kappa", "Akutagawa", R.drawable.kappa, SERVIDOR + "kappa.mp3", Libro.G_S_XIX,
            false, false));
